...
export default function CeoDashboardPage() {
  ...
  useEffect(() => {
    ...
    api.get('/api/dashboard/ceo').then(res => {
        if(res.data.success) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          <div 
              onClick={() => navigate('/ceo/recruitment')}
          ...
          >
              <div className="flex items-center gap-4">
                  ...
                  <div>
                      <p className="text-sm font-medium text-slate-500">Quản lý Tuyển dụng</p>
                      <h3 className="text-2xl font-bold text-slate-800">{stats.openJobs || 0}</h3>
                  </div>
              </div>
          ...
          <div 
              onClick={() => navigate('/ceo/payroll?status=DRAFT')}
              className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex items-center justify-between cursor-pointer hover:border-blue-300 hover:shadow-md transition-all group"
          >
              <div className="flex items-center gap-4">
                  ...
                  <div>
                      <p className="text-sm font-medium text-slate-500">Quản lý Bảng lương</p>
