...
public class RecruitmentController {
    ...
    public ResponseEntity<ApiResponse<Application>> approveByDirector(
            @PathVariable Long id,
            @org.springframework.security.core.annotation.AuthenticationPrincipal com.hrm.security.CustomUserDetails userDetails) {
        Application app = applicationService.approveByDirector(id, userDetails);
    ...
    public ResponseEntity<ApiResponse<Application>> rejectByDirector(
        ...
        Application app = applicationService.rejectByDirector(id, request.reason(), userDetails);
